...
using TopCrypto.Controllers.Root;
using TopCrypto.DataLayer.Data.Models;
using TopCrypto.Models.AccountViewModels;
...
namespace TestAuth.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [HttpPost("Login")]
        [AllowAnonymous]
        public async Task<JsonResult> Login([FromBody]LoginViewModel model/*, [FromQuery]string returnUrl = null*/)
        {
            //ViewData["ReturnUrl"] = returnUrl;
